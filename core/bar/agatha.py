...
from utils.paletteLatte import paletteLatte as Latte
from utils.paletteFrappe import paletteFrappe as Frappe
...
groups = lambda bg: GroupBox(
    **symbol(),
    ...
    highlight_color=Frappe.crust,
    highlight_method="line",
    inactive=Frappe.surface2,
    invert=True,
    padding=6,
    rainbow=True,
)
...
widgets = lambda: [
    ...
    # logo(palette.lavender, Latte.text),
    ...
    *clock(Frappe.crust, Frappe.mauve),
    widget.Spacer(length=1),
]